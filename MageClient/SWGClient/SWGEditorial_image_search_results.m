...
@implementation SWGEditorial_image_search_results
        ...
        if([images_dict isKindOfClass:[NSArray class]]) {
            ...
            if([(NSArray*)images_dict count] > 0) {
                for (NSDictionary* dict in (NSArray*)images_dict) {
                    SWGEditorial_image_search_item* d = [[SWGEditorial_image_search_item  alloc] initWithValues:dict];
                    [objs addObject:d];
                }
...
-(NSDictionary*) asDictionary {
    ...
    if(_images != nil){
        ...
        NSMutableArray * array = [[NSMutableArray alloc] init];
            for( SWGEditorial_image_search_item *images in _images) {
